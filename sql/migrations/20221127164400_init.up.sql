...
CREATE TABLE actions (id VARCHAR(37) NOT NULL PRIMARY KEY, match_id VARCHAR(36) NOT NULL, team_id VARCHAR(36) NOT NULL, player_id VARCHAR(36) NOT NULL, action VARCHAR(255) NOT NULL, minute INTEGER NOT NULL, score DECIMAL(10,2) NOT NULL);